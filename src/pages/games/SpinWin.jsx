...
const SEGMENT_ANGLE = 360 / 14;

const PRIZE_TIERS_DISPLAY = [
  { label: "$1,000", color: "#00ff88", chance: "28%" },
  { label: "$10,000", color: "#00d4ff", chance: "12%" },
  { label: "$50,000", color: "#f0c040", chance: "4%" },
  { label: "Physical Prize", color: "#c084fc", chance: "1%" },
  { label: "? Loss", color: "#ff4444", chance: "55%" },
];
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <div style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem" }}>
            Win $1K, $10K, $50K or a physical prize. Land on ? and the house
            wins.
          </p>
        </div>
